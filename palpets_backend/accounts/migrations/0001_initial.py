    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('user', 'مستخدم عادي'), ('breeder', 'مربي'), ('vet', 'طبيب بيطري'), ('shelter', 'ملجأ'), ('admin', 'مدير')], default='user', max_length=20, verbose_name='نوع المستخدم')),
